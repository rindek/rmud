  ...
  module Actions
    class Move < Abstract
      ...
      def call
        ...
        yield object.environment.remove_from_inventory

        ## add object to new inventory
        dest.inventory.add(object)

        ## set object's new environment
        yield object.environment.update(dest)
      ...
      def validate_after_move(object:, dest:)
        return Failure(:wrong_object_environment) unless object.environment.environment == dest
